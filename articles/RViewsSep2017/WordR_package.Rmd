...
I revved up the Google machinery. I found packages like [R2wd](https://CRAN.R-project.org/package=R2wd), [officer](https://CRAN.R-project.org/package=officer) and [ReporteRs](https://CRAN.R-project.org/package=ReporteRs). They are all very good packages but for different reasons none of them covers 100% of my needs, or they make things unnecessarily complicated (again, for my needs).
